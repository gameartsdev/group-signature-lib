...
#include "group_sig/algorithm/LinearPair.h"
#include "group_sig/algorithm/GroupSigInterface.h"
...
{
public:
    BBSGroupSig(string config_path = "", string gpk_dir = "") : GroupSigInterface(config_path, gpk_dir)
    {
    }
